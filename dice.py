...
def roll_dice(num_dice):
    """Returns a list of integers with length 'num_deice'.
...
def generate_dice_faces_diagram(dice_values):
    ...
    For example, if 'dice_values = [4,1,3,2]' then the string looks like this:
...
# 3. Generate an ASCII diagram of dice faces
